...
.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box-wrap .uabb-slide-front {
	<?php
	if ( 'yes' === $converted || isset( $settings->front_padding_dimension_top ) && isset( $settings->front_padding_dimension_bottom ) && isset( $settings->front_padding_dimension_left ) && isset( $settings->front_padding_dimension_right ) ) {
...
.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box-wrap .uabb-slide-down {
	<?php
	if ( 'yes' === $converted || isset( $settings->back_padding_dimension_top ) && isset( $settings->back_padding_dimension_bottom ) && isset( $settings->back_padding_dimension_left ) && isset( $settings->back_padding_dimension_right ) ) {
...
.fl-node-<?php echo esc_attr( $id ); ?> .fl-module-content .uabb-slide-dropdown .uabb-icon i:before {
	...
	<?php
	if ( 'style2' === $settings->slide_type ) {
		?>
	color: <?php echo esc_attr( $settings->dropdown_icon_color ); ?>;
	background: <?php echo wp_kses_post( uabb_theme_base_color( $settings->dropdown_icon_bg_color ) ); ?>;
	border-radius: 100%;
	...
	text-align: center;
		...
		?>
	color: <?php echo wp_kses_post( uabb_theme_base_color( $settings->dropdown_plus_icon_color ) ); ?>;
		<?php
	}
	?>
}
...
.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box-overlay .uabb-icon i:before {
	color: <?php echo wp_kses_post( uabb_theme_base_color( $settings->overlay_icon_color ) ); ?>;
...
if ( 'style1' === $settings->slide_type ) {
	...
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box-wrap .uabb-style1.open-slidedown .uabb-slide-front:hover {
	...
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-style1.open-slidedown .uabb-slide-box .uabb-slide-box-section-content {
		color: <?php echo wp_kses_post( uabb_theme_text_color( $settings->front_desc_focused_color ) ); ?>;
		transition: all linear 300ms;
	}
...
if ( 'style2' === $settings->slide_type ) {
	...
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box-wrap {
		<?php echo ( '' !== $settings->dropdown_icon_size ) ? 'margin-bottom: ' . esc_attr( ( ( $settings->dropdown_icon_size * 1.75 ) / 2 ) ) . 'px;' : ''; ?>
	}
	...
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box-wrap .uabb-style2.open-slidedown .uabb-slide-front:hover {
		background: <?php echo esc_attr( $settings->focused_front_background_color ); ?>;
		transition: all linear 300ms;
	}

	<?php
	if ( 'center' !== $settings->dropdown_icon_align ) {
		?>
...
if ( 'style3' === $settings->slide_type ) {
	...
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box-wrap .uabb-style3.open-slidedown .uabb-slide-front:hover {
		background: <?php echo esc_attr( $settings->focused_front_background_color ); ?>;
		transition: all linear 300ms;
	}

	.fl-node-<?php echo esc_attr( $id ); ?> .fl-module-content .uabb-style3 .uabb-slide-dropdown {
		justify-content: <?php echo esc_attr( ( 'left' === $settings->dropdown_icon_align ) ? 'flex-start' : ( ( 'right' === $settings->dropdown_icon_align ) ? 'flex-end' : '' ) ); ?>;
	}
	<?php
}
?>
...
<?php if ( ! $version_bb_check ) { ?>
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-face-text-title {
		...
		<?php if ( 'none' !== $settings->front_title_transform ) : ?>
			text-transform: <?php echo esc_attr( $settings->front_title_transform ); ?>;
		<?php endif; ?>

		<?php if ( '' !== $settings->front_title_letter_spacing ) : ?>
			letter-spacing: <?php echo esc_attr( $settings->front_title_letter_spacing ); ?>px;
		<?php endif; ?>
...
<?php if ( ! $version_bb_check ) { ?>
	...
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-box-section-content {
		...
		<?php if ( 'none' !== $settings->front_desc_transform ) : ?>
			text-transform: <?php echo esc_attr( $settings->front_desc_transform ); ?>;
		<?php endif; ?>

		<?php if ( '' !== $settings->front_desc_letter_spacing ) : ?>
			letter-spacing: <?php echo esc_attr( $settings->front_desc_letter_spacing ); ?>px;
		<?php endif; ?>
	}
	<?php
} else {
...
<?php if ( ! $version_bb_check ) { ?>
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-back-text-title {
		...
		<?php if ( 'none' !== $settings->back_transform ) : ?>
			text-transform: <?php echo esc_attr( $settings->back_transform ); ?>;
		<?php endif; ?>

		<?php if ( '' !== $settings->back_letter_spacing ) : ?>
			letter-spacing: <?php echo esc_attr( $settings->back_letter_spacing ); ?>px;
		<?php endif; ?>
	}
	<?php
} else {
...
<?php if ( ! $version_bb_check ) { ?>
	...
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-down-box-section-content {
		...
		<?php if ( 'none' !== $settings->back_desc_transform ) : ?>
			text-transform: <?php echo esc_attr( $settings->back_desc_transform ); ?>;
		<?php endif; ?>

		<?php if ( '' !== $settings->back_desc_letter_spacing ) : ?>
			letter-spacing: <?php echo esc_attr( $settings->back_desc_letter_spacing ); ?>px;
		<?php endif; ?>
	}
	<?php
} else {
...
.fl-builder-content .fl-node-<?php echo esc_attr( $id ); ?> a.uabb-callout-cta-link:visited {
	color: <?php echo wp_kses_post( uabb_theme_text_color( $settings->link_color ) ); ?>;
}
<?php endif; ?>
	...
	@media ( max-width: <?php echo esc_attr( $global_settings->medium_breakpoint ); ?>px ) {
		...
		<?php if ( ! $version_bb_check ) { ?>
			.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-down-box-section-content {
				...
				<?php if ( isset( $settings->back_desc_font_size['medium'] ) && '' === $settings->back_desc_font_size['medium'] && isset( $settings->back_desc_line_height['medium'] ) && '' !== $settings->back_desc_line_height['medium'] && '' === $settings->back_desc_line_height_unit_medium && '' === $settings->back_desc_line_height_unit ) { ?>
		...
		<?php if ( ! $version_bb_check ) { ?>
			.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-back-text-title {
				...
				<?php if ( isset( $settings->back_title_font_size['medium'] ) && '' === $settings->back_title_font_size['medium'] && isset( $settings->back_title_line_height['medium'] ) && '' !== $settings->back_title_line_height['medium'] && '' === $settings->back_title_line_height_unit_medium && '' === $settings->back_title_line_height_unit ) { ?>
	...
	@media ( max-width: <?php echo esc_attr( $global_settings->responsive_breakpoint ); ?>px ) {
		...
		<?php if ( ! $version_bb_check ) { ?>
			.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-box-section-content {
				...
				<?php if ( 'yes' === $converted || isset( $settings->front_desc_font_size_unit_responsive ) && '' !== $settings->front_desc_font_size_unit_responsive ) { ?>
					...
					<?php if ( '' === $settings->front_desc_line_height_unit_responsive && '' !== $settings->front_desc_line_height_unit_responsive ) { ?>
							line-height: <?php $settings->front_desc_font_size_unit_responsive + 2; ?>px;
					<?php } ?>
				<?php } elseif ( isset( $settings->front_desc_font_size_unit_responsive ) && '' === $settings->front_desc_font_size_unit_responsive && isset( $settings->front_desc_font_size['small'] ) && '' !== $settings->front_desc_font_size['small'] ) { ?>
					font-size: <?php echo esc_attr( $settings->front_desc_font_size['small'] ); ?>px;
					line-height: <?php $settings->front_desc_font_size['small'] + 2; ?>px;
				<?php } ?>

				<?php if ( isset( $settings->front_desc_font_size['small'] ) && '' === $settings->front_desc_font_size['small'] && isset( $settings->front_desc_line_height['small'] ) && '' !== $settings->front_desc_line_height['small'] && '' === $settings->front_desc_line_height_unit_responsive && '' === $settings->front_desc_line_height_unit && '' === $settings->front_desc_line_height_unit_medium ) { ?>
		...
		<?php if ( ! $version_bb_check ) { ?>
			.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-face-text-title {
				...
				<?php if ( 'yes' === $converted || isset( $settings->front_title_font_size_unit_responsive ) && '' !== $settings->front_title_font_size_unit_responsive && 0 !== $settings->front_title_font_size_unit_responsive ) { ?>
						font-size: <?php echo esc_attr( $settings->front_title_font_size_unit_responsive ); ?>px;
					<?php if ( '' === $settings->front_title_line_height_unit_responsive && '' !== $settings->front_title_line_height_unit_responsive ) { ?>
							line-height: <?php $settings->front_title_font_size_unit_responsive + 2; ?>px;
					<?php } ?>
				<?php } elseif ( isset( $settings->front_title_font_size_unit_responsive ) && '' === $settings->front_title_font_size_unit_responsive && isset( $settings->front_title_font_size['small'] ) && '' !== $settings->front_title_font_size['small'] ) { ?>
					...
					line-height: <?php $settings->front_title_font_size['small'] + 2; ?>px;
				<?php } ?>

				<?php if ( isset( $settings->front_title_font_size['small'] ) && '' === $settings->front_title_font_size['small'] && isset( $settings->front_title_line_height['small'] ) && '' !== $settings->front_title_line_height['small'] && '' === $settings->front_title_line_height_unit_responsive && '' === $settings->front_title_line_height_unit && '' === $settings->front_title_line_height_unit_medium ) { ?>
		...
		<?php if ( ! $version_bb_check ) { ?>
			.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-down-box-section-content {
				...
				<?php if ( 'yes' === $converted || isset( $settings->back_desc_font_size_unit_responsive ) && '' !== $settings->back_desc_font_size_unit_responsive && 0 !== $settings->back_desc_font_size_unit_responsive ) { ?>
						font-size: <?php echo esc_attr( $settings->back_desc_font_size_unit_responsive ); ?>px;
					<?php if ( '' === $settings->back_desc_line_height_unit_responsive && '' !== $settings->back_desc_line_height_unit_responsive ) { ?>
							line-height: <?php $settings->back_desc_font_size_unit_responsive + 2; ?>px;
					<?php } ?>
				<?php } elseif ( isset( $settings->back_desc_font_size_unit_responsive ) && '' === $settings->back_desc_font_size_unit_responsive && isset( $settings->back_desc_font_size['small'] ) && '' !== $settings->back_desc_font_size['small'] ) { ?>
						font-size: <?php echo esc_attr( $settings->back_desc_font_size['small'] ); ?>px;
						line-height: <?php $settings->back_desc_font_size['small'] + 2; ?>px;
				<?php } ?>

				<?php if ( isset( $settings->back_desc_font_size['small'] ) && '' === $settings->back_desc_font_size['small'] && isset( $settings->back_desc_line_height['small'] ) && '' !== $settings->back_desc_line_height['small'] && '' === $settings->back_desc_line_height_unit_responsive && '' === $settings->back_desc_line_height_unit_medium && '' === $settings->back_desc_line_height_unit ) { ?>
		...
		<?php if ( ! $version_bb_check ) { ?>
			.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-box .uabb-slide-back-text-title {
				...
				<?php if ( 'yes' === $converted || isset( $settings->back_title_font_size_unit_responsive ) && '' !== $settings->back_title_font_size_unit_responsive && 0 !== $settings->back_title_font_size_unit_responsive ) { ?>
						font-size: <?php echo esc_attr( $settings->back_title_font_size_unit_responsive ); ?>px;
					<?php if ( '' === $settings->back_title_line_height_unit_responsive && '' !== $settings->back_title_line_height_unit_responsive ) { ?>
							line-height: <?php $settings->back_title_font_size_unit_responsive + 2; ?>px;
					<?php } ?>
				<?php } elseif ( isset( $settings->back_title_font_size_unit_responsive ) && '' === $settings->back_title_font_size_unit_responsive && isset( $settings->back_title_font_size['small'] ) && '' !== $settings->back_title_font_size['small'] ) { ?>
						font-size: <?php echo esc_attr( $settings->back_title_font_size['small'] ); ?>px;
						line-height: <?php $settings->back_title_font_size['small'] + 2; ?>px;
				<?php } ?>

				<?php if ( isset( $settings->back_title_font_size['small'] ) && '' === $settings->back_title_font_size['small'] && isset( $settings->back_title_line_height['small'] ) && '' !== $settings->back_title_line_height['small'] && '' === $settings->back_title_line_height_unit_responsive && '' === $settings->back_title_line_height_unit && '' === $settings->back_title_line_height_unit_medium ) { ?>
		...
		<?php if ( ! $version_bb_check ) { ?>
			.fl-builder-content .fl-node-<?php echo esc_attr( $id ); ?> .uabb-callout-cta-link {
				<?php if ( 'yes' === $converted || isset( $settings->link_font_size_unit_responsive ) && '' !== $settings->link_font_size_unit_responsive && 0 !== $settings->link_font_size_unit_responsive ) { ?>
						font-size: <?php echo esc_attr( $settings->link_font_size_unit_responsive ); ?>px;
					<?php if ( '' === $settings->link_line_height_unit_responsive && '' !== $settings->link_line_height_unit_responsive ) { ?>
				...
				<?php if ( isset( $settings->link_font_size['small'] ) && '' === $settings->link_font_size['small'] && isset( $settings->link_line_height['small'] ) && '' !== $settings->link_line_height['small'] && '' === $settings->link_line_height_unit_responsive && '' === $settings->link_line_height_unit && '' === $settings->link_line_height_unit_medium ) { ?>
...
/* 
 * Button Alignment Fix for Slide Box Module
 * 
 * This fixes the issue where buttons in the slide-down area don't respect 
 * their alignment settings due to the global CSS rule that sets 
 * text-align: inherit for .uabb-slide-down .uabb-button-center
 */
?>

/* Fix button alignment in slide-down area - Override global inherit rule */
.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-left {
	text-align: left !important;
}

.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-center {
	text-align: center !important;
}

.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-right {
	text-align: right !important;
}

/* Responsive button alignment fixes */
@media (max-width: 768px) {
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-responsive-left {
		text-align: left !important;
	}

	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-responsive-center {
		text-align: center !important;
	}

	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-responsive-right {
		text-align: right !important;
	}
}

@media (max-width: 1024px) and (min-width: 769px) {
	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-medium-left {
		text-align: left !important;
	}

	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-medium-center {
		text-align: center !important;
	}

	.fl-node-<?php echo esc_attr( $id ); ?> .uabb-slide-down .uabb-button-medium-right {
		text-align: right !important;
	}
}
