...
$settings->title_bg_hover_color = FLBuilderColor::hex_or_rgb( $settings->title_bg_hover_color );
...
if ( isset( $settings->title_bg_color ) && '' !== $settings->title_bg_color ) {
	...
	if ( null !== $r && null !== $g && null !== $b ) {
		echo 'background: rgba(' . intval( $r ) . ', ' . intval( $g ) . ', ' . intval( $b ) . ', ' . floatval( $opacity_decimal ) . ');';
	} else {
		echo 'background: ' . esc_attr( $settings->title_bg_color ) . ';';
	}
}
?>
...
.fl-node-<?php echo esc_attr( $id ); ?> .uabb-adv-accordion-button<?php echo esc_attr( $id ); ?> .uabb-adv-accordion-button-icon {
	<?php if ( isset( $settings->icon_color ) && '' !== $settings->icon_color ) : ?>
...
.fl-node-<?php echo esc_attr( $id ); ?> .uabb-adv-accordion-content<?php echo esc_attr( $id ); ?> {
	...
	if ( isset( $settings->content_bg_color ) && '' !== $settings->content_bg_color ) {
		...
		if ( null !== $r && null !== $g && null !== $b ) {
			...
			echo 'background: ' . esc_attr( $settings->content_bg_color ) . ';';
		}
	}
	?>
	<?php
...
?>
<?php if ( isset( $settings->content_color ) && '' !== $settings->content_color ) : ?>
...
/* Hover State */
<?php if ( isset( $settings->title_hover_color ) && '' !== $settings->title_hover_color ) : ?>
...
.fl-node-<?php echo esc_attr( $id ); ?> .uabb-adv-accordion-item-active > .uabb-adv-accordion-button<?php echo esc_attr( $id ); ?> {
	...
	if ( isset( $hover_color ) && '' !== $hover_color ) {
		...
		if ( null !== $r && null !== $g && null !== $b ) {
			...
			echo 'background: ' . esc_attr( $hover_color ) . ';';
		}
	}
	?>
}

<?php if ( isset( $settings->icon_hover_color ) && '' !== $settings->icon_hover_color ) : ?>
