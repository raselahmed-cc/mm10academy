		...
		'reCAPTCHA'  => array(
			...
			'sections' => array(
				...
				'turnstile_general' => array(
					...
					'description' => '<div style="line-height: 1em; margin-left:20px; background:#e4e7ea; padding:15px;">' . __( 'Please configure your Cloudflare Turnstile keys in', 'uabb' ) . ' <a href="' . admin_url( 'options-general.php?page=uabb-builder-settings#uabb-turnstile' ) . '" target="_blank"> <b>UABB Settings → Turnstile Settings</b> </a>. </div>',
					'fields'      => array(
						'uabb_lf_turnstile_toggle' => array(
							'type'    => 'select',
							'label'   => __( 'Turnstile Field', 'uabb' ),
							'default' => 'hide',
							'options' => array(
								'show' => __( 'Show', 'uabb' ),
								'hide' => __( 'Hide', 'uabb' ),
