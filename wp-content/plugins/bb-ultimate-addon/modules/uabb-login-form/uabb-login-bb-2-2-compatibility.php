	...
	array(
		...
		'reCAPTCHA'  => array(
			...
			'sections' => array(
				...
				'recaptcha_general' => array(
					...
					'fields'      => array(
						'uabb_lf_recaptcha_toggle'        => array(
							...
							'toggle'  => array(
								'show' => array(
									'fields' => array( 'uabb_lf_recaptcha_version', 'uabb_lf_recaptcha_site_key', 'uabb_lf_recaptcha_secret_key', 'uabb_lf_v3_recaptcha_site_key', 'uabb_lf_v3_recaptcha_secret_key', 'uabb_lf_recaptcha_theme', 'uabb_lf_badge_position' ),
								),
							),
						),
				...
				'turnstile_general' => array(
					'title'       => __( 'Cloudflare Turnstile', 'uabb' ),
					'description' => sprintf( /* translators: %s: search term */ __( 'Configure Turnstile keys in <a%1$s>UABB Settings → Turnstile Settings</a>. Get your keys from <a%2$s>Cloudflare Dashboard</a>.', 'uabb' ), ' href="' . admin_url( 'options-general.php?page=uabb-builder-settings#uabb-turnstile' ) . '" target="_blank" style="text-decoration: none;"', ' href="https://dash.cloudflare.com/" target="_blank" style="text-decoration: none;"' ),
					'fields'      => array(
						'uabb_lf_turnstile_toggle' => array(
							'type'    => 'select',
							'label'   => __( 'Enable Turnstile', 'uabb' ),
							'default' => 'hide',
							'options' => array(
								'show' => __( 'Yes', 'uabb' ),
								'hide' => __( 'No', 'uabb' ),
							),
							'help'    => __( 'To use Turnstile, configure site and secret keys in UABB Settings → Turnstile Settings', 'uabb' ),
							'preview' => array(
								'type' => 'none',
							),
						),
