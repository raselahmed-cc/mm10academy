...
= 1.5.4.1 ( 2026-03-19 ) =
* Fixed thumbnail being cropped incorrectly when exporting images
* Fixed incorrect image dimensions in item details panel
* Fixed timeout when downloading zip files of libraries with many items
