...
Thrive Ovation is a plugin that helps you collect and display testimonials on your website.

## Requirements
* NodeJS - [info here](https://nodejs.org/)

## Before checkout
The folder that you are using for checkout should be called `thrive-ovation`.
