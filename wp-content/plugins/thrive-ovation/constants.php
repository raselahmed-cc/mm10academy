 ...
 * TO plugin version
 */
defined( 'TVO_VERSION' ) || define( 'TVO_VERSION', '10.8.10' );
...
define( 'TVO_UPDATE_URL', 'https://service-api.thrivethemes.com/plugin/update' );
...
defined( 'TVO_TCM_COMMENTS' ) || define( 'TVO_TCM_COMMENTS', '5' );
...
defined( 'TVO_LOG_SOURCE_THRIVE_COMMENTS' ) || define( 'TVO_LOG_SOURCE_THRIVE_COMMENTS', 'source_thrive_comments' );
 ...
 * Menu video URLs
 */
defined( 'TVO_CAPTURE_USING_LANDING_PAGE_ACTIVE' ) || define( 'TVO_CAPTURE_USING_LANDING_PAGE_ACTIVE', '5GdzdRKL7G4' );
defined( 'TVO_CAPTURE_USING_LANDING_PAGE_INACTIVE' ) || define( 'TVO_CAPTURE_USING_LANDING_PAGE_INACTIVE', 'd9rgh2e12aM' );

defined( 'TVO_CAPTURE_USING_CONTENT_BUILDER_ACTIVE' ) || define( 'TVO_CAPTURE_USING_CONTENT_BUILDER_ACTIVE', '-YwjZ7Hgd6M' );
defined( 'TVO_CAPTURE_USING_CONTENT_BUILDER_INACTIVE' ) || define( 'TVO_CAPTURE_USING_CONTENT_BUILDER_INACTIVE', 'd9rgh2e12aM' );

defined( 'TVO_CAPTURE_USING_LEADS_ACTIVE' ) || define( 'TVO_CAPTURE_USING_LEADS_ACTIVE', 'VShi0j5mhmo' );
defined( 'TVO_CAPTURE_USING_LEADS_INACTIVE' ) || define( 'TVO_CAPTURE_USING_LEADS_INACTIVE', 'd9rgh2e12aM' );

defined( 'TVO_DISPLAY_USING_CONTENT_BUILDER_ACTIVE' ) || define( 'TVO_DISPLAY_USING_CONTENT_BUILDER_ACTIVE', 'MUx4MIl1Gz0' );
defined( 'TVO_DISPLAY_USING_CONTENT_BUILDER_INACTIVE' ) || define( 'TVO_DISPLAY_USING_CONTENT_BUILDER_INACTIVE', 'd9rgh2e12aM' );

defined( 'TVO_DISPLAY_USING_LEADS_ACTIVE' ) || define( 'TVO_DISPLAY_USING_LEADS_ACTIVE', '5GdzdRKL7G4' );
defined( 'TVO_DISPLAY_USING_LEADS_INACTIVE' ) || define( 'TVO_DISPLAY_USING_LEADS_INACTIVE', 'd9rgh2e12aM' );

/**
 * Define an hook that triggers when a testimonial is added through capture form
 */
defined( 'TVO_ACTION_TESTIMONIAL_ADDED_CAPTURE_FORM' ) || define( 'TVO_ACTION_TESTIMONIAL_ADDED_CAPTURE_FORM', 'tvo_testimonial_added_through_capture_form' );


/**
 * Define custom post types for capture and display testimonials
 */
defined( 'TVO_CAPTURE_POST_TYPE' ) || define( 'TVO_CAPTURE_POST_TYPE', 'tvo_capture_post' );
defined( 'TVO_DISPLAY_POST_TYPE' ) || define( 'TVO_DISPLAY_POST_TYPE', 'tvo_display_post' );
