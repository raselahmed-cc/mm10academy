<div id="<?php echo $unique_id; ?>" class="tvo-testimonials-display tvo-testimonials-display-grid tvo-set1-small-template tve_green">
		...
		<?php if ( ! empty( $testimonial ) ) : ?>
			<div class="tvo-item-col tvo-item-s12 tvo-item-m12 tvo-item-l12 ">
				<div class="tvo-testimonial-display-item tvo-apply-background">
					...
					<svg height="15" viewBox="0 0 600 7" preserveAspectRatio="none" class="tvo-testimonial-line tvo-separator-svg-stroke">
						<polyline points="0,7 290,7 300,0 310,7 600 7"></polyline>
					</svg>
					<div class="tvo-row">
						<div class="tvo-col tvo-s4 tvo-m3 tvo-l2">
						...
						<div class="tvo-col tvo-s8 tvo-m9 tvo-l10">
