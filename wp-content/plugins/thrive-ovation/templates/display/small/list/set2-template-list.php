<div id="<?php echo $unique_id; ?>" class="tvo-testimonials-display tvo-testimonials-display-grid tvo-set2-small-template tve_green">
		...
		<?php if ( ! empty( $testimonial ) ) : ?>
			<div class="tvo-item-col tvo-item-s12 tvo-item-m12 tvo-item-l12 ">
				<div class="tvo-testimonial-display-item tvo-apply-background">
					...
					<?php endif; ?>
					<div class="tvo-background-wrapper">
