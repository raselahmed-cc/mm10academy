<div id="<?php echo $unique_id; ?>" class="tvo_testimonial_form tvo-set2-template tve_black">
		...
		<div class="tvo-item-grid">
			<div class="tvo-item-l3 tvo-item-m12 tvo-item-col">
				<div class="tvo-set2-image">
					<img src="<?php echo TVO_URL . 'templates/css/images/capture-set2-image.png'; ?>" alt="" height="94" width="100"/>
				</div>
			</div>
