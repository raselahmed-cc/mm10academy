<div id="<?php echo $unique_id; ?>" class="tvo_testimonial_form tvo-default-template tve_blue">
	<div class="tvo_form_state">
		<div class="tvo_inputs_container tvo-item-grid">
			...
			<?php if ( ! empty( $config['website_url_display'] ) ) : ?>
				<div class="tvo-form-field tvo-item-m12 tvo-item-col">
					<input autocomplete="off" class="tvo-form-input tvo_input tvo_website_url <?php echo $config['website_url_required'] ? 'tvo_required' : ''; ?>" type="text" name="website_url" placeholder="<?php echo $config['website_url_label'] ?>"/>
				</div>
			<?php endif; ?>
			<?php if ( ! empty( $config['title_display'] ) ) : ?>
				<div class="tvo-form-field tvo-item-m12 tvo-item-col">
					<input autocomplete="off" class="tvo-form-input tvo_input <?php echo $config['title_required'] ? 'tvo_required' : ''; ?>" type="text" name="title" placeholder="<?php echo $config['title_label'] ?>"/>
				</div>
			<?php endif; ?>
	...
	<div class="tvo_success_state" style="display: none;">
		<img src="<?php echo TVO_URL . 'templates/css/images/capture-default-image.png'; ?>" alt="" class="tvo-align-center" height="94" width="100"/>
