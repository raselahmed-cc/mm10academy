 ...
 *
 */
class TCB_Testimonial_Website_Element extends \TCB_Post_List_Sub_Element_Abstract {
	...
	public function name() {
		return __( 'Website', 'thrive-ovation' );
	}
	...
	public function identifier() {
		return '.thrive-testimonial-website';
	}
	...
	public function shortcode() {
		return 'tvo_testimonial_website';
	}
	...
	public function own_components() {
		...
		foreach ( $components['typography']['config'] as $control => $config ) {
			...
			$components['typography']['config'][ $control ]['css_suffix'] = [ ' a', ' span.thrive-shortcode-content', ' .thrv_text_element' ];
		}
