...
/**
 * Class TCB_Testimonial_Content_Element
 *
 */
class TCB_Testimonial_Content_Element extends \TCB_Post_List_Sub_Element_Abstract {
	...
	public function name() {
		return __( 'Testimonial Content', 'thrive-ovation' );
	}
	...
	public function identifier() {
		return '.thrive-testimonial-content';
	}
	...
	public function shortcode() {
		return 'tvo_testimonial_content';
	}

	public function html() {
		return Shortcodes::testimonial_content();
	}
	...
	public function own_components() {
		...
		foreach ( $components['typography']['config'] as $control => $config ) {
			...
			$components['typography']['config'][ $control ]['css_suffix'] = [ ' div.tcb-plain-text', ' div.tcb-plain-text *' ];
		}
